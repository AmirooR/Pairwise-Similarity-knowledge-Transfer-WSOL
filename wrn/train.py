"""Training executable for coloc detection models.

This executable is used to train CoLocDetectionModels. There are two ways of
...
from rcnn_attention.wrn import trainer
...
def get_configs_from_pipeline_file():
  ...
  if FLAGS.calibration:
    train_config = pipeline_config.calib_config
    input_config = pipeline_config.calib_input_reader
...
def main(_):
  ...
  k_shot = model_config.wrn_attention.k_shot
  ...
  create_input_dict_fn = functools.partial(
      ...
      dataflow_config=input_config,
      k_shot=model_config.wrn_attention.k_shot,
      queue_size=train_config.batch_size*2,
      is_training=True,
